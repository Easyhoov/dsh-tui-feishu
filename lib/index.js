...
export function apply(ctx, config = {}) {
    ...
    const startBridge = (credentials) => {
        ...
        const cards = (config.cardEngine ?? 'cardkit') === 'cardkit'
        ...
        void reminders
            ...
            .then(() => transport
            .start()
            .then(() => logger.info(`[dsh-tui-feishu] bridge ready for app ${credentials.appId} (card engine: ${config.cardEngine ?? 'cardkit'})`))
            .catch((error) => {
