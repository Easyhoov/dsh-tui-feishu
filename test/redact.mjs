...
// ── redactInlineSecrets ────────────────────────────────────────────────
test('redacts API_KEY=sk-xxx assignment', () => {
...
test('redacts quoted secret assignment', () => {
...
test('redacts --flag secret pairs', () => {
...
test('basenameOnly strips directories', () => {
...
test('redactPaths keeps only basenames', () => {
...
// ── sanitizeToolDetail ─────────────────────────────────────────────────
test('command sanitizer redacts secrets and paths', () => {
...
test('humanizes and titles tool names', () => {
